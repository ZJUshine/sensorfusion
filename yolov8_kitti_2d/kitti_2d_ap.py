...
if __name__ == '__main__':
    gt_dir = '/home/usslab/SensorFusion/sensorfusion/yolov8_kitti_2d/label_val'
    # pred_dir = '/home/usslab/SensorFusion/sensorfusion/yolov8_kitti_2d/detection_2d_yolo/camera_acoustic_blur_linear'
    for dataset_name in ['kitti','camera_acoustic_blur_linear','camera_emi_strip_loss','camera_emi_truncation','camera_laser_hiding','camera_laser_strip_injection','camera_projection_creating']:
        pred_dir = f'/home/usslab/SensorFusion/sensorfusion/yolov8_kitti_2d/detection_2d_yolo/{dataset_name}'
        #Car,  Pedestrian, Cyclist
        cls = 'Car'
        print("dataset_name: ", dataset_name, "cls: ", cls) 
